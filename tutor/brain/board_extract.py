...
_KNOWN_KINDS = ("FORMULA", "TERM", "FACT", "CODE")
...
_EXTRACTION_SYSTEM = (
    ...
    "формулы, ключевые термины с определением и важные факты, и вернуть "
    "ТОЛЬКО блок тегов для доски, БЕЗ устного текста и БЕЗ маркера "
