...
Answer-style adaptation (length, vocabulary, "explain like to a child")
is deliberately NOT here — the main agent self-adapts from the dialogue.
Keeping meta light matters: it sits on the answer's critical path.
