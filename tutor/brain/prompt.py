...
PROFESSOR_GOAL = (
    ...
    "и перечисли формулы и ключевые термины тегами для интерактивной доски:\n"
    ...
    "СХЕМЫ: когда студент просит «нарисуй», «покажи схему», «изобрази», "
    "«покажи поток / последовательность / состояния» — выноси Mermaid-диаграмму "
    "в [BOARD-MERMAID]. Поддерживаются flowchart (`flowchart TD` / `LR`), "
    "sequenceDiagram, stateDiagram-v2, classDiagram. Подписи на узлах и "
    "стрелках — на русском. Голосом опиши, что куда ведёт; синтаксис "
    "Mermaid в речь НЕ произноси.\n"
