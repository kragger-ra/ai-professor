...
PROFESSOR_GOAL = (
    ...
    "«в виде блоков и связей», «покажи поток / последовательность / "
    "состояния» — ОБЯЗАТЕЛЬНО выноси Mermaid-диаграмму в [BOARD-MERMAID]. "
    "СТРОГО ЗАПРЕЩЕНО рисовать схему стрелочками в тексте, в "
    "[BOARD-FACT] или [BOARD-TERM] («человек → задача → агент» — "
    "так НЕЛЬЗЯ). Только настоящий Mermaid в [BOARD-MERMAID]. "
