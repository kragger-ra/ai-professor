...
with demo:
    ...
    with gr.Tab(label="Settings"):
        gr.Markdown(
            ...
            "`.env`; **restart** the agent (`stop_professor.bat` then `start_professor_tutor.bat`) "
        ...
        settings_inputs = []
        settings_input_keys = []  # parallel list of env-var names to write
        ...
        def _save_settings(*values):
            ...
            return (
                ...
                "\nRestart required: run stop_professor.bat then start_professor_tutor.bat "
