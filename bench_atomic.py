"""Benchmark atomic-llama-cpp-turboquant with Gemma 4 MTP speculative decoding.

Same prompts and structure as bench_lmstudio.py — only the endpoint differs.
Direct compare: identical prompts, identical max_tokens/temperature.
"""
import json
import statistics
import sys
...
MODEL = "gemma-4-e4b"  # llama-server alias; not strictly used
